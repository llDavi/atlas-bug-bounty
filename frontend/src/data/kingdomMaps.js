...
export const KINGDOM_MAPS = {
  ...
  mobile: {
    ...
    places: [
      ...
      { kind: "ruin", x: 838, y: 470, label: "above", name: "Taking the Ship Apart", domain: "Reverse engineering" },
      { kind: "keep", x: 900, y: 600, label: "left", name: "final", domain: "" },
    ],
    roads: [
      [0, 1, "road"], [0, 2, "path"], [1, 3, "road"], [1, 2, "path"],
      [3, 4, "road"], [3, 5, "path"], [4, 6, "road"], [5, 6, "path"], [6, 7, "ford"],
    ],
    annotations: [
  ...
  networks: {
    ...
    places: [
      ...
      { kind: "forest", x: 440, y: 560, label: "below", name: "Secrets in the Wild", domain: "Keys in repos & CI" },
      { kind: "keep", x: 560, y: 118, label: "above", name: "final", domain: "" },
    ],
    roads: [
      [0, 1, "path"], [1, 2, "path"], [2, 3, "road"], [1, 3, "path"],
      [3, 4, "road"], [3, 5, "path"], [4, 5, "path"], [2, 6, "path"], [4, 6, "ford"], [3, 7, "path"],
    ],
    annotations: [
  ...
  "smart-contracts": {
    ...
    places: [
      { kind: "vault", x: 224, y: 336, label: "below", name: "1", domain: "" },
      { kind: "tower", x: 372, y: 236, label: "above", name: "2", domain: "" },
      { kind: "gate", x: 520, y: 330, label: "below", name: "3", domain: "" },
      { kind: "vault", x: 672, y: 240, label: "above", name: "4", domain: "" },
      { kind: "market", x: 772, y: 396, label: "right", name: "5", domain: "" },
      { kind: "keep", x: 500, y: 500, label: "below", name: "final", domain: "" },
    ],
    roads: [
